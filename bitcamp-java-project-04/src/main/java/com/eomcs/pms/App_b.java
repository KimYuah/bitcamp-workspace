...
public class App_b {
  ...
  public static void main(String[] args) {
    ...
    now1 = new java.sql.Date(currentMillis);
    System.out.println();
    ...
    if(response.equals("Y") || response.equals("Y")) {  
      ...
      currentMillis = System.currentTimeMillis(); 
      now2 = new java.sql.Date(currentMillis);
      System.out.println();
      ...
      if(response.equalsIgnoreCase("Y")){
        ...
        currentMillis = System.currentTimeMillis(); 
        now3 = new java.sql.Date(currentMillis);
        System.out.println();
        ...
        if(response.equalsIgnoreCase("Y")){
          ...
          currentMillis = System.currentTimeMillis(); 
          now4 = new java.sql.Date(currentMillis);
          System.out.println();
        ...
        currentMillis = System.currentTimeMillis(); 
        now5 = new java.sql.Date(currentMillis);
        System.out.println();
