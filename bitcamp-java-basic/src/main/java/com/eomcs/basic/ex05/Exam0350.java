...
// => 방법: 파란색 계통을 강화(|OR)하거나
//          빨랑이나 초록을 약화(&AND)시키면 된다.
// => 다음과 같이 한 개의 점이 있다.
//    10001100 10010010 10101100 (변경전 색)
...
//
// 1920 * 1080 = 207_3600 픽셀 or 도트
// 1 픽셀
// Red(8bit) + Green(8bit) + Blue(8bit)
// = 3 byte/pixel
// = 1677_7216 색상

// 207_3600 pixel * 3 byte = 622_8900 byte = 6082 KB = 5.94MB
//
// 1000_0000 * 3 = 3000_0000 = 29_296KB = 28.6MB(raw date file)
//
// 80분 영화
// = 80분 * 60 * 24()
// = 11_5200
// 용량
// == 115200 * 6MB = 691200(MB) = 675GB ==> 4GB(손실압축, MPEG)
