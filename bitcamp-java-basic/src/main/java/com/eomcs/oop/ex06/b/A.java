...
public class A {
  ...
  static public void m(String a, int b) { // 순서가 달라도 상관없다 구분할 수 있으니까
    System.out.println("m(String,int)");
  }

  static public void m(int a, String b) { // 순서가 달라도 상관없다 구분할 수 있으니까
...
//    static public void m(int x, String y) { // 중복된 메소드라 불가하다
//        System.out.println("m(int,String)");
//    }
